    ...
    return (< >
        ...
        <div className="flex flex-col lg:flex-row items-center m-10">
            ...
            <div className="lg:w-1/2 m-2 lg:p-5">
                <p className="text-lg  md:text-xl lg:text-2xl text-gray-800"><strong className="lg:text-2xl text-xl text-driverGreen">DriverRidey</strong> core mission is to eliminate transportation
        ...
        {/* big Image */}
        <div className="relative w-full lg:h-[80vh] h-[50vh] bg-gradient-to-r from-blue-500 via-teal-500 to-purple-500 "
            style={{
        ...
        {/* proble we solve */}
        <div className="flex lg:flex-row flex-col lg:items-center m-10">
            <div className="lg:w-1/2 flex-col" >
                <h2 className="lg:text-6xl md:text-5xl text-2xl font-bold text-driverGreen text-center lg:pb-2">The Problem We Solve</h2>
                <p className="text-lg md:text-xl lg:text-2xl text-black m-5  justify-center lg:text-left max-w-3xl mx-auto sm:mx-0 pl-2">
